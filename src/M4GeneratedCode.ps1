...
$resourceArray = @('AppConfiguration','Blockchain','ConnectedKubernetes','CustomProviders','DesktopVirtualization','Databricks','HanaOnAzure','ImageBuilder','ImportExport','KubernetesConfiguration','Kusto','MariaDb','MonitoringSolutions','MySql','Portal','PostgreSql','TimeSeriesInsights')
...
foreach ($resource in $resourceArray) {
    ...
    try
    {
        ...
        autorest-beta | Write-Information
        ./build-module.ps1
